...
API docs available at [https://bitops.kotlincrypto.org][url-docs]

### Modules

 - [bits](library/bits/README.md)
 - [endian](library/endian/README.md)
...
[url-docs]: https://bitops.kotlincrypto.org
[url-latest-release]: https://github.com/KotlinCrypto/bitops/releases/latest
